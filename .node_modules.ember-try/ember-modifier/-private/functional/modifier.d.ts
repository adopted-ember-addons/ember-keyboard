...
export declare type FunctionalModifier<P extends ModifierArgs['positional'] = ModifierArgs['positional'], N extends ModifierArgs['named'] = ModifierArgs['named']> = (element: Element, positional: P, named: N) => unknown;
/**
