...
export declare class MonomorphicTagImpl implements MonomorphicTag {
    private revision;
    private lastChecked;
    private lastValue;
    private isUpdating;
...
export declare function combineTagged(tagged: ReadonlyArray<Tagged>): Tag;
export declare function combineSlice(slice: Slice<Tagged & LinkedListNode>): Tag;
