...
export { AotRuntime, default as EnvironmentImpl, DefaultEnvironment, CustomJitRuntime, JitRuntimeFromProgram, JitRuntime, RuntimeEnvironment, RuntimeEnvironmentDelegate, ScopeImpl, JitSyntaxCompilationContext, } from './lib/environment';
...
export { renderAot, renderAotComponent, renderAotMain, RenderComponentArgs, renderJitComponent, renderJitMain, renderSync, } from './lib/render';
