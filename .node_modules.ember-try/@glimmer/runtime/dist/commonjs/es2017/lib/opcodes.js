    ...
    debugAfter(vm, pre) {
        ...
        if (false) {
            ...
            if (vm[_symbols.STACKS].scope.current === null) {
                ...
                console.log('%c -> scope', 'color: green', vm.scope().slots.map(s => (0, _environment.isScopeReference)(s) ? s.value() : s));
            }
