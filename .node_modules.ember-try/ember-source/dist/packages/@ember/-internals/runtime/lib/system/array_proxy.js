...
@module @ember/array
*/
import { get, objectAt, alias, PROPERTY_DID_CHANGE, addArrayObserver, removeArrayObserver, replace, CUSTOM_TAG_FOR, arrayContentDidChange, tagForProperty } from '@ember/-internals/metal';
