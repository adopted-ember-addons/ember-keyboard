/*! For license information please see chunk.788.b174e795d1067b49ad60.js.LICENSE.txt */
...
break}return n}function A(e,t){return-1!==t.indexOf(e)}function I(e){var t=M("array",e)?[]:{}
...
default:return s(e)}}function M(e,t){return q(t)===e}function O(e,t){for(var n=e+""+t,r=0,i=0;i<n.length;i++)r=(r<<5)-r+n.charCodeAt(i),r|=0
...
function a(e,t){var n=q(e)
return q(t)===n&&o[n](e,t)}function u(t,n){if(arguments.length<2)return!0
e=[{a:t,b:n}]
...
return e.length=0,t}}(),U={queue:[],stats:{all:0,bad:0,testCount:0},blocking:!0,failOnZeroTests:!0,reorder:!0,altertitle:!0,collapse:!0,scrolltop:!0,maxDepth:5,requireExpects:!1,urlConfig:[],modules:[],currentModule:{name:"",tests:[],childModules:[],testsRun:0,testsIgnored:0,hooks:{before:[],beforeEach:[],afterEach:[],after:[]}},callbacks:{},storage:x},B=g&&g.QUnit&&g.QUnit.config
g&&g.QUnit&&!g.QUnit.version&&R(U,B),U.modules.push(U.currentModule)
...
function Q(e,t,n){var r=H.length?H.slice(-1)[0]:null,i=null!==r?[r.name,e].join(" > "):e,o=r?r.suiteReport:$e,s=null!==r&&r.skip||n.skip,a=null!==r&&r.todo||n.todo,u={name:i,parentModule:r,tests:[],moduleId:O(i),testsRun:0,testsIgnored:0,childModules:[],suiteReport:new F(e,o),skip:s,todo:!s&&a,ignored:n.ignored||!1},l={}
return r&&(r.childModules.push(u),R(l,r.testEnvironment)),R(l,t),u.testEnvironment=l,U.modules.push(u),u}function $(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:{}
"function"===q(t)&&(n=t,t=void 0)
...
if(U.currentModule=i,"function"===q(n)){H.push(i)
try{var l=n.call(i.testEnvironment,a)
null!=l&&"function"===q(l.then)&&E.warn("Returning a promise from a module callback is not supported. Instead, use hooks for async behavior. This will become an error in QUnit 3.0.")}finally{H.pop(),U.currentModule=i.parentModule||u}}function c(e,t,n){var r=t[n]
...
function W(e,t){if("string"!==q(e))throw new TypeError("eventName must be a string when emitting an event")
...
function se(){var e,t
e=_(),U.depth=(U.depth||0)+1,ae(e),U.depth--,oe.length||U.blocking||U.current||(U.blocking||U.queue.length||0!==U.depth?(t=U.queue.shift()(),oe.push.apply(oe,f(t)),ie>0&&ie--,se()):function(){var e
...
var t=U.storage,n=_()-U.started,r=U.stats.all-U.stats.bad
ue.finished=!0,W("runEnd",$e.end(!0)),X("done",{passed:r,failed:U.stats.bad,total:U.stats.all,runtime:n}).then((function(){if(t&&0===U.stats.bad)for(var e=t.length-1;e>=0;e--){var n=t.key(e)
0===n.indexOf("qunit-test-")&&t.removeItem(n)}}))}())}function ae(e){if(oe.length&&!U.blocking){var t=_()-e
if(!y||U.updateRate<=0||t<U.updateRate){var n=oe.shift()
K.resolve(n()).then((function(){oe.length?ae(e):se()}))}else y(se)}}var ue={finished:!1,add:function(e,t,n){if(t)U.queue.splice(ie++,0,e)
...
N.measure("QUnit Test: ".concat(t),"qunit_test_start","qunit_test_end")}return R(this.start(),{runtime:this.getRuntime(),status:this.getStatus(),errors:this.getFailedAssertions(),assertions:this.getAssertions()})}},{key:"pushAssertion",value:function(e){this.assertions.push(e)}},{key:"getRuntime",value:function(){return this._endTime-this._startTime}},{key:"getStatus",value:function(){return this.skipped?"skipped":(this.getFailedAssertions().length>0?this.todo:!this.todo)?this.todo?"todo":"passed":"failed"}},{key:"getFailedAssertions",value:function(){return this.assertions.filter((function(e){return!e.passed}))}},{key:"getAssertions",value:function(){return this.assertions.slice()}},{key:"slimAssertions",value:function(){this.assertions=this.assertions.map((function(e){return delete e.actual,delete e.expected,e}))}}]),e}()
...
this.testId=O(this.module.name,this.testName),this.module.tests.push({name:this.testName,testId:this.testId,skip:!!this.skip}),this.skip?(this.callback=function(){},this.async=!1,this.expected=0):this.assert=new Ce(this)}}function fe(){if(!U.current)throw new Error("pushFailure() assertion outside test context, in "+ne(2))
var e=U.current
return e.pushFailure.apply(e,arguments)}function de(){if(U.pollution=[],U.noglobals)for(var e in p)if(C.call(p,e)){if(/^qunit-test-output/.test(e))continue
...
return n.reverse()}(t).reduce((function(e,t){return e.then((function(){return t.stats={all:0,bad:0,started:_()},W("suiteStart",t.suiteReport.start(!0)),X("moduleStart",{name:t.name,tests:t.tests})}))}),K.resolve([])).then((function(){return U.current=e,e.testEnvironment=R({},t.testEnvironment),e.started=_(),W("testStart",e.testReport.start(!0)),X("testStart",{name:e.testName,module:t.name,testId:e.testId,previousFailure:e.previousFailure}).then((function(){U.pollution||de()}))}))},run:function(){if(U.current=this,this.callbackStarted=_(),U.notrycatch)e(this)
else try{e(this)}catch(e){this.pushFailure("Died on test #"+(this.assertions.length+1)+" "+this.stack+": "+(e.message||e),te(e,0)),de(),U.blocking&&we(this)}function e(e){var t
...
this.runtime=_()-this.started,U.stats.all+=this.assertions.length,U.stats.testCount+=1,t.stats.all+=this.assertions.length
...
n.hooks={},t.push.apply(t,f(n.childModules))}return W("suiteEnd",e.suiteReport.end(!0)),X("moduleDone",{name:e.name,tests:e.tests,failed:e.stats.bad,passed:e.stats.all-e.stats.bad,total:e.stats.all,runtime:_()-e.stats.started})}(t)}))}),K.resolve([]))}})).then((function(){U.current=void 0}))},preserveTestEnvironment:function(){this.preserveEnvironment&&(this.module.testEnvironment=this.testEnvironment,this.testEnvironment=R({},this.module.testEnvironment))},queue:function(){var e=this
...
if("function"===q(r)){var i=be(n),o=function(){i()}
U.notrycatch?r.call(e,o):r.call(e,o,(function(e){var r="Promise rejected "+(t?t.replace(/Each$/,""):"during")+' "'+n.testName+'": '+(e&&e.message||e)
n.pushFailure(r,te(e,0)),de(),we(n)}))}}},valid:function(){var e=U.filter,t=/^(!?)\/([\w\W]*)\/(i?$)/.exec(e),n=U.module&&U.module.toLowerCase(),r=this.module.name+": "+this.testName
return!(!this.callback||!this.callback.validTest)||!(U.moduleId&&U.moduleId.length>0&&!function e(t){return A(t.moduleId,U.moduleId)||t.parentModule&&e(t.parentModule)}(this.module))&&!(U.testId&&U.testId.length>0&&!A(this.testId,U.testId))&&!(n&&!function e(t){return(t.name?t.name.toLowerCase():null)===n||!!t.parentModule&&e(t.parentModule)}(this.module))&&(!e||(t?this.regexFilter(!!t[1],t[2],t[3],r):this.stringFilter(e,r)))},regexFilter:function(e,t,n,r){return new RegExp(t,n).test(r)!==e},stringFilter:function(e,t){e=e.toLowerCase(),t=t.toLowerCase()
var n="!"!==e.charAt(0)
return n||(e=e.slice(1)),-1!==t.indexOf(e)?n:!n}}
var he=!1
function pe(e){he||U.currentModule.ignored||new ce(e).queue()}function ge(e){U.currentModule.ignored||(he||(U.queue.length=0,he=!0),new ce(e).queue())}function me(e,t){pe({testName:e,callback:t})}function ve(e,t){return"".concat(e," [").concat(t,"]")}function ye(e,t){if(Array.isArray(e))e.forEach(t)
...
i.remaining--,0===i.remaining&&e.pauses.delete(r),ke(e)}}return e.pauses.set(r,i),y&&("number"==typeof e.timeout?n=e.timeout:"number"==typeof U.testTimeout&&(n=U.testTimeout),"number"==typeof n&&n>0&&(U.timeoutHandler=function(t){return function(){U.timeout=null,i.cancelled=!0,e.pauses.delete(r),e.pushFailure("Test took longer than ".concat(t,"ms; test timed out."),ne(2)),ke(e)}},b(U.timeout),U.timeout=y(U.timeoutHandler(n),n))),o}function we(e){e.pauses.forEach((function(e){e.cancelled=!0})),e.pauses.clear(),ke(e)}function ke(e){e.pauses.size>0||(y?(b(U.timeout),U.timeout=y((function(){e.pauses.size>0||(b(U.timeout),U.timeout=null,We())}))):We())}function xe(e){for(var t=[].concat(e.tests),n=f(e.childModules);n.length;){var r=n.shift()
t.push.apply(t,r.tests),n.push.apply(n,f(r.childModules))}return t}function Ee(e){return e.testsRun+e.testsIgnored===xe(e).length}function Te(e){for(e.testsIgnored++;e=e.parentModule;)e.testsIgnored++}R(me,{todo:function(e,t){pe({testName:e,callback:t,todo:!0})},skip:function(e){pe({testName:e,skip:!0})},only:function(e,t){ge({testName:e,callback:t})},each:function(e,t,n){ye(t,(function(t,r){pe({testName:ve(e,r),callback:n,withData:!0,data:t})}))}}),me.todo.each=function(e,t,n){ye(t,(function(t,r){pe({testName:ve(e,r),callback:n,todo:!0,withData:!0,data:t})}))},me.skip.each=function(e,t){ye(t,(function(t,n){pe({testName:ve(e,n),skip:!0})}))},me.only.each=function(e,t,n){ye(t,(function(t,r){ge({testName:ve(e,r),callback:n,withData:!0,data:t})}))}
...
var t
this.test.timeout=e,U.timeout&&(b(U.timeout),U.timeout=null,U.timeoutHandler&&this.test.timeout>0&&(t=this.test.timeout,b(U.timeout),U.timeout=y(U.timeoutHandler(t),t)))}},{key:"step",value:function(e){var t=e,n=!!e
this.test.steps.push(e),"undefined"===q(e)||""===e?t="You must provide a message to assert.step":"string"!==q(e)&&(t="You must provide a string value to assert.step",n=!1),this.pushResult({result:n,message:t})}},{key:"verifySteps",value:function(e,t){var n=this.test.steps.slice()
...
this.pushResult({result:r,actual:e,expected:t,message:n,negative:!0})}},{key:"propEqual",value:function(e,t,n){e=I(e),t=I(t),this.pushResult({result:P(e,t),actual:e,expected:t,message:n})}},{key:"notPropEqual",value:function(e,t,n){e=I(e),t=I(t),this.pushResult({result:!P(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"deepEqual",value:function(e,t,n){this.pushResult({result:P(e,t),actual:e,expected:t,message:n})}},{key:"notDeepEqual",value:function(e,t,n){this.pushResult({result:!P(e,t),actual:e,expected:t,message:n,negative:!0})}},{key:"strictEqual",value:function(e,t,n){this.pushResult({result:t===e,actual:e,expected:t,message:n})}},{key:"notStrictEqual",value:function(e,t,n){this.pushResult({result:t!==e,actual:e,expected:t,message:n,negative:!0})}},{key:"throws",value:function(t,n,r){var i=c(_e(n,r,"throws"),2)
n=i[0],r=i[1]
var o=this instanceof e&&this.test||U.current
if("function"===q(t)){var s,a=!1
...
if("function"===q(s)){var a=this.async()
...
function _e(e,t,n){var r=q(e)
if("string"===r){if(void 0===t)return t=e,[e=void 0,t]
throw new Error("assert."+n+" does not accept a string value for the expected argument.\nUse a non-string object value (e.g. RegExp or validator function) instead if necessary.")}if(e&&"regexp"!==r&&"function"!==r&&"object"!==r)throw new Error("Invalid expected value type ("+r+") provided to assert."+n+".")
return[e,t]}function Se(e,t,n){var r=!1,i=q(t)
...
var Ne,je,Ae,Ie,Re=function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
Ne=Me.FORCE_COLOR,je=Me.NODE_DISABLE_COLORS,Ae=Me.NO_COLOR,Ie=Me.TERM,qe=process.stdout&&process.stdout.isTTY}var Oe={enabled:!je&&null==Ae&&"dumb"!==Ie&&(null!=Ne&&"0"!==Ne||qe),reset:Pe(0,0),bold:Pe(1,22),dim:Pe(2,22),italic:Pe(3,23),underline:Pe(4,24),inverse:Pe(7,27),hidden:Pe(8,28),strikethrough:Pe(9,29),black:Pe(30,39),red:Pe(31,39),green:Pe(32,39),yellow:Pe(33,39),blue:Pe(34,39),magenta:Pe(35,39),cyan:Pe(36,39),white:Pe(37,39),gray:Pe(90,39),grey:Pe(90,39),bgBlack:Pe(40,49),bgRed:Pe(41,49),bgGreen:Pe(42,49),bgYellow:Pe(43,49),bgBlue:Pe(44,49),bgMagenta:Pe(45,49),bgCyan:Pe(46,49),bgWhite:Pe(47,49)}
...
break
default:t=e}return t}var Fe={console:Re,tap:function(){function e(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{}
...
n+="\n  message: ".concat(Be(e.message||"failed")),n+="\n  severity: ".concat(Be(t||"failed")),Ue.call(e,"actual")&&(n+="\n  actual  : ".concat(Be(e.actual))),Ue.call(e,"expected")&&(n+="\n  expected: ".concat(Be(e.expected))),e.stack&&(n+="\n  stack: ".concat(Be(e.stack+"\n"))),n+="\n  ...",this.log(n)}},{key:"logError",value:function(e){var t="  ---"
t+="\n  message: ".concat(Be(L(e))),t+="\n  severity: ".concat(Be("failed")),e&&e.stack&&(t+="\n  stack: ".concat(Be(e.stack+"\n"))),t+="\n  ...",this.log(t)}}],[{key:"init",value:function(t,n){return new e(t,n)}}]),e}()}
function He(e){U.current?U.current.assert.pushResult({result:!1,message:"global failure: ".concat(L(e)),source:e&&e.stack||ne(2)}):($e.globalFailureCount++,U.stats.bad++,U.stats.all++,W("error",e))}var Qe={},$e=new F
U.currentModule.suiteReport=$e
var ze=!1,Ge=!1
function Ye(){Ge=!0,y?y((function(){We()})):We()}function Je(){U.blocking=!1,ue.advance()}function We(){if(U.started)Je()
else{U.started=_(),""===U.modules[0].name&&0===U.modules[0].tests.length&&U.modules.shift()
for(var e=U.modules.length,t=[],n=0;n<e;n++)t.push({name:U.modules[n].name,tests:U.modules[n].tests})
W("runStart",$e.start(!0)),X("begin",{totalTests:ce.count,modules:t}).then(Je)}}Qe.isLocal=g&&g.location&&"file:"===g.location.protocol,Qe.version="2.17.2",R(Qe,{config:U,dump:D,equiv:P,reporters:Fe,is:M,objectType:q,on:function(e,t){if("string"!==q(e))throw new TypeError("eventName must be a string when registering a listener")
if(!A(e,J)){var n=J.join(", ")
throw new Error('"'.concat(e,'" is not a valid event; must be one of: ').concat(n,"."))}if("function"!==q(t))throw new TypeError("callback must be a function when registering a listener")
Y[e]||(Y[e]=[]),A(t,Y[e])||Y[e].push(t)},onError:function(e){if(E.warn("QUnit.onError is deprecated and will be removed in QUnit 3.0. Please use QUnit.onUncaughtException instead."),U.current&&U.current.ignoreGlobalErrors)return!0
var t=new Error(e.message)
return t.stack=e.stacktrace||e.fileName+":"+e.lineNumber,He(t),!1},onUncaughtException:He,pushFailure:fe,assert:Ce.prototype,module:G,test:me,todo:me.todo,skip:me.skip,only:me.only,start:function(e){if(U.current)throw new Error("QUnit.start cannot be called inside a test context.")
var t=ze
...
if(!U.pageLoaded)return U.autostart=!0,void(w||Qe.load())
...
return R.apply(this,t)},load:function(){U.pageLoaded=!0,R(U,{started:0,updateRate:1e3,autostart:!0,filter:""},!0),Ge||(U.blocking=!1,U.autostart&&Ye())},stack:function(e){return ne(e=(e||0)+2)}}),function(e){var t=["begin","done","log","testStart","testDone","moduleStart","moduleDone"]
function n(e){return function(t){if("function"!==q(t))throw new Error("QUnit logging methods require a callback function as their first parameters.")
U.callbacks[e].push(t)}}for(var r=0,i=t.length;r<i;r++){var o=t[r]
"undefined"===q(U.callbacks[o])&&(U.callbacks[o]=[]),e[o]=n(o)}}(Qe),function(i){var o=!1
if(g&&w){if(g.QUnit&&g.QUnit.version)throw new Error("QUnit has already been defined.")
g.QUnit=i,o=!0}e&&e.exports&&(e.exports=i,e.exports.QUnit=i,o=!0),t&&(t.QUnit=i,o=!0),void 0===(r=function(){return i}.call(t,n,t,e))||(e.exports=r),i.config.autostart=!1,o=!0,m&&m.WorkerGlobalScope&&m instanceof m.WorkerGlobalScope&&(m.QUnit=i,o=!0),o||(p.QUnit=i)}(Qe),function(){if(g&&w){var e=Qe.config,t=Object.prototype.hasOwnProperty
Qe.begin((function(){if(!t.call(e,"fixture")){var n=w.getElementById("qunit-fixture")
n&&(e.fixture=n.cloneNode(!0))}})),Qe.testStart((function(){if(null!=e.fixture){var t=w.getElementById("qunit-fixture")
...
_.obj=C
var N=d(_)
if(null!==N&&!(N<v)&&(_.score=N,w<y?(g.add(_),++w):(++k,N>g.peek().score&&g.replaceTop(_)),m%1e3==0&&Date.now()-s>=10))return void(e?setImmediate(x):setTimeout(x))}else if(i&&i.key){for(var j=i.key;m>=0;--m)if((A=c(C=n[m],j))&&(f(A)||(A=p.getPrepared(A)),null!==(I=b(t,A,h))&&!(I.score<v)&&(I={target:I.target,_targetLowerCodes:null,_nextBeginningIndexes:null,score:I.score,indexes:I.indexes,obj:C},w<y?(g.add(I),++w):(++k,I.score>g.peek().score&&g.replaceTop(I)),m%1e3==0&&Date.now()-s>=10)))return void(e?setImmediate(x):setTimeout(x))}else for(;m>=0;--m){var A,I
if((A=n[m])&&(f(A)||(A=p.getPrepared(A)),null!==(I=b(t,A,h))&&!(I.score<v)&&(w<y?(g.add(I),++w):(++k,I.score>g.peek().score&&g.replaceTop(I)),m%1e3==0&&Date.now()-s>=10)))return void(e?setImmediate(x):setTimeout(x))}if(0===w)return a(r)
for(var R=new Array(w),q=w-1;q>=0;--q)R[q]=g.poll()
...
s&&v.warn("Support for PhantomJS is deprecated and will be removed in QUnit 3.0."),s||"complete"!==w.readyState?l(g,"load",Qe.load):Qe.load()
var a=g.onerror
...
return e&&(e.disabled=!0,e.innerHTML="Aborting..."),Qe.config.queue.length=0,!1}function E(e){var t=b("qunit-filter-input")
return t.value=u(t.value),_(),e&&e.preventDefault&&e.preventDefault(),!1}function T(){var n,r,i,o=this,s={}
if(r="selectedIndex"in o?o.options[o.selectedIndex].value||void 0:o.checked?o.defaultValue||!0:void 0,s[o.name]=r,n=C(s),"hidepassed"===o.name&&"replaceState"in g.history){if(Qe.urlParams[o.name]=r,e[o.name]=r||!1,i=b("qunit-tests")){var a=i.children.length,u=i.children
...
return t&&(n="<span class='module-name'>"+Xe(t)+"</span>: "),n+"<span class='test-name'>"+Xe(e)+"</span>"}function I(e){return[e.completed," / ",e.defined," tests completed.<br />"].join("")}function q(e){return e.replace(/<\/?[^>]+(>|$)/g,"").replace(/&quot;/g,"").replace(/\s+/g,"")}}(),Qe.diff=function(){function e(){}var t=-1,n=Object.prototype.hasOwnProperty
...
n.r(t),n.d(t,{Headers:()=>h,Request:()=>w,Response:()=>x,DOMException:()=>T,fetch:()=>C})
var r="URLSearchParams"in self,i="Symbol"in self&&"iterator"in Symbol,o="FileReader"in self&&"Blob"in self&&function(){try{return new Blob,!0}catch(e){return!1}}(),s="FormData"in self,a="ArrayBuffer"in self
...
e.bodyUsed=!0}function g(e){return new Promise((function(t,n){e.onload=function(){t(e.result)},e.onerror=function(){n(e.error)}}))}function m(e){var t=new FileReader,n=g(t)
...
return Promise.resolve(new Blob([this._bodyText]))},this.arrayBuffer=function(){return this._bodyArrayBuffer?p(this)||Promise.resolve(this._bodyArrayBuffer):this.blob().then(m)}),this.text=function(){var e,t,n,r=p(this)
if(r)return r
...
return Promise.resolve(this._bodyText)},s&&(this.formData=function(){return this.text().then(k)}),this.json=function(){return this.text().then(JSON.parse)},this}h.prototype.append=function(e,t){e=c(e),t=f(t)
var n=this.map[e]
...
if(this.credentials=t.credentials||this.credentials||"same-origin",!t.headers&&this.headers||(this.headers=new h(t.headers)),this.method=(r=(n=t.method||this.method||"GET").toUpperCase(),b.indexOf(r)>-1?r:n),this.mode=t.mode||this.mode||null,this.signal=t.signal||this.signal,this.referrer=null,("GET"===this.method||"HEAD"===this.method)&&i)throw new TypeError("Body not allowed for GET or HEAD requests")
this._initBody(i)}function k(e){var t=new FormData
return e.trim().split("&").forEach((function(e){if(e){var n=e.split("="),r=n.shift().replace(/\+/g," "),i=n.join("=").replace(/\+/g," ")
t.append(decodeURIComponent(r),decodeURIComponent(i))}})),t}function x(e,t){t||(t={}),this.type="default",this.status=void 0===t.status?200:t.status,this.ok=this.status>=200&&this.status<300,this.statusText="statusText"in t?t.statusText:"OK",this.headers=new h(t.headers),this.url=t.url||"",this._initBody(e)}w.prototype.clone=function(){return new w(this,{body:this._bodyInit})},y.call(w.prototype),y.call(x.prototype),x.prototype.clone=function(){return new x(this._bodyInit,{status:this.status,statusText:this.statusText,headers:new h(this.headers),url:this.url})},x.error=function(){var e=new x(null,{status:0,statusText:""})
return e.type="error",e}
var E=[301,302,303,307,308]
x.redirect=function(e,t){if(-1===E.indexOf(t))throw new RangeError("Invalid status code")
return new x(null,{status:t,headers:{location:e}})}
var T=self.DOMException
try{new T}catch(e){(T=function(e,t){this.message=e,this.name=t
var n=Error(e)
this.stack=n.stack}).prototype=Object.create(Error.prototype),T.prototype.constructor=T}function C(e,t){return new Promise((function(n,r){var i=new w(e,t)
if(i.signal&&i.signal.aborted)return r(new T("Aborted","AbortError"))
var s=new XMLHttpRequest
function a(){s.abort()}s.onload=function(){var e,t,r={status:s.status,statusText:s.statusText,headers:(e=s.getAllResponseHeaders()||"",t=new h,e.replace(/\r?\n[\t ]+/g," ").split(/\r?\n/).forEach((function(e){var n=e.split(":"),r=n.shift().trim()
if(r){var i=n.join(":").trim()
t.append(r,i)}})),t)}
r.url="responseURL"in s?s.responseURL:r.headers.get("X-Request-URL")
var i="response"in s?s.response:s.responseText
n(new x(i,r))},s.onerror=function(){r(new TypeError("Network request failed"))},s.ontimeout=function(){r(new TypeError("Network request failed"))},s.onabort=function(){r(new T("Aborted","AbortError"))},s.open(i.method,i.url,!0),"include"===i.credentials?s.withCredentials=!0:"omit"===i.credentials&&(s.withCredentials=!1),"responseType"in s&&o&&(s.responseType="blob"),i.headers.forEach((function(e,t){s.setRequestHeader(t,e)})),i.signal&&(i.signal.addEventListener("abort",a),s.onreadystatechange=function(){4===s.readyState&&i.signal.removeEventListener("abort",a)}),s.send(void 0===i._bodyInit?null:i._bodyInit)}))}C.polyfill=!0,self.fetch||(self.fetch=C,self.Headers=h,self.Request=w,self.Response=x)}}])
