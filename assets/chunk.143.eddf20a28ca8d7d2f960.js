...
r.r(t),r.d(t,{click:()=>v,getCode:()=>F,getKeyCode:()=>j,getMouseCode:()=>o,keyDown:()=>h.QG,keyPress:()=>h.W0,keyResponder:()=>d,keyUp:()=>h.yR,mouseDown:()=>k,mouseUp:()=>g,onKey:()=>l,touchEnd:()=>O,touchStart:()=>K,triggerKeyDown:()=>P,triggerKeyPress:()=>x,triggerKeyUp:()=>C})
var n=r(1866)
...
const p=["left","middle","right"].concat(b.Z),m=function(e,t){const r=void 0!==t?t.split("+"):[]
return function(e){e.forEach((e=>{-1===p.indexOf(e)&&console.error(`\`${e}\` is not a valid key name`)}))}(r),(0,u.Z)(e,r)}
function v(e){return m("click",e)}function k(e){return m("mousedown",e)}function g(e){return m("mouseup",e)}const _=function(e,t){return function(e){(void 0!==e?e.split("+"):[]).forEach((e=>{-1===b.Z.indexOf(e)&&console.error(`\`${e}\` is not a valid key name`)}))}(t),(0,u.Z)(e,t)}
...
var i,s,a=r.n(o),d=r(8574),u=r(7219),c=r(8048),l=r(5997)
r(6806),r(5547),r(3353),r(2412),r(3284),r(1866)
const y=["input","select","textarea"]
let f=(i=class extends(a()){constructor(){super(...arguments),(0,n.b)(this,"keyboard",s,this),(0,n._)(this,"keyboardPriority",0),(0,n._)(this,"activatedParamValue",!0),(0,n._)(this,"eventName","keydown"),(0,n._)(this,"onlyWhenFocused",!0),(0,n._)(this,"listenerName",void 0)}didReceiveArguments(){let[e,t]=this.args.positional,{activated:r,event:n,priority:o}=this.args.named
this.keyCombo=e,this.callback=t,this.eventName=n||"keydown",this.activatedParamValue=Object.keys(this.args.named).includes("activated")?!!r:void 0,this.keyboardPriority=o?parseInt(o,10):0,this.listenerName=(0,c.Z)(this.eventName,this.keyCombo),void 0!==this.args.named.onlyWhenFocused?this.onlyWhenFocused=this.args.named.onlyWhenFocused:this.onlyWhenFocused=y.includes(this.element.tagName.toLowerCase())}didInstall(){this.keyboard.register(this),this.onlyWhenFocused&&(this.element.addEventListener("click",this.onFocus,!0),this.element.addEventListener("focus",this.onFocus,!0),this.element.addEventListener("focusout",this.onFocusOut,!0))}willRemove(){this.onlyWhenFocused&&(this.element.removeEventListener("click",this.onFocus,!0),this.element.removeEventListener("focus",this.onFocus,!0),this.element.removeEventListener("focusout",this.onFocusOut,!0)),this.keyboard.unregister(this)}onFocus(){this.isFocused=!0}onFocusOut(){this.isFocused=!1}get keyboardActivated(){return!1!==this.activatedParamValue&&(!this.onlyWhenFocused||this.isFocused)}get keyboardFirstResponder(){return!!this.onlyWhenFocused&&this.isFocused}canHandleKeyboardEvent(e){return(0,l.default)(this.listenerName,e)}handleKeyboardEvent(e,t){(0,l.default)(this.listenerName,e)&&(this.callback?this.callback(e,t):this.element.click())}},s=(0,n.a)(i.prototype,"keyboard",[d.inject],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,n.a)(i.prototype,"onFocus",[u.action],Object.getOwnPropertyDescriptor(i.prototype,"onFocus"),i.prototype),(0,n.a)(i.prototype,"onFocusOut",[u.action],Object.getOwnPropertyDescriptor(i.prototype,"onFocusOut"),i.prototype),i)},9665:(e,t,r)=>{"use strict"
...
r.forEach(t.bind(null,0)),r.push=t.bind(null,r.push.bind(r))})(),n.O(void 0,[813],(()=>n(4396)))
var o=n.O(void 0,[813],(()=>n(9132)))
